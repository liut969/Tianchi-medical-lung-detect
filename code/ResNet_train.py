...
x_train, y_train = get_image_and_label(sets=['train_part1', 'train_part2', 'train_part3', 'train_part4'],
                                    ...
                                    predict_path=['./cut_csv/lt_yolov3_014_cut_part1.csv', './cut_csv/lt_yolov3_014_cut_part2.csv',
...
x_test, y_test = get_image_and_label(sets=['train_part5'],
                                    data_path='../data',
                                    anns_path='../data/chestCT_round1_annotation.csv',
                                    predict_path=['./cut_csv/lt_yolov3_014_cut_part5.csv'],
                                    target_size=64,
                                    )
...
model_name = model_type + 'ep{epoch:03d}-loss{loss:.3f}-val_loss{val_loss:.3f}.h5'
...
callbacks = [checkpoint, lr_reducer, lr_scheduler, logging, early_stopping]
...
if not data_augmentation:
    ...
    model.fit(x_train, y_train,
              ...
              shuffle=True,
              callbacks=callbacks)
    model.save(os.path.join(save_dir, 'trained_weights_final_ResNet.h5'))
